...
export async function getSession(req, res) {
  ...
  // 4) No live Supabase session. Mark the request as conclusively unauthenticated
  // so downstream router fallbacks cannot decode the stale JWT and resurrect
  // the UI from a service-role profile lookup.
  req.__merveilAuthChecked = true;
