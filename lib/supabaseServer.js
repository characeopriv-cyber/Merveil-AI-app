...
export async function getSession(req, res) {
  ...
  //    token — return user:null for write paths — but expose sub so callers
  //    (directory) can use service role with known identity.
  return { token: null, user: null, jwtSub: jwtSub || null };
}
