...
function shell(content) {
  ...
  <div class="shell">
    <aside class="sidebar ${state.sidebarOpen ? 'open' : ''}">
      ...
      <div style="margin:0 12px 10px;padding:6px 10px;border-radius:8px;font-size:10px;font-weight:700;letter-spacing:0.06em;text-align:center;background:rgba(99,102,241,0.15);color:#a5b4fc;border:1px solid rgba(129,140,248,0.35)">EARLY ACCESS · DEMO</div>
      <nav class="nav">
        ${navItem('home', '⌘', 'Home')}
